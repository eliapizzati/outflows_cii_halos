...
"""
This is the main script to plot results for the mcmc routines; it is used to create the plots for the paper
In particular, it contains the following figures:
- Figure 0 (requires gnedincooling): emission from the sampling for a single system (used in the paper)
- Figure 1 (requires gnedincooling): emission from the sampling for all the systems together
- Figure 2: corner plots for a single system (used in the paper)
- Figure 3: violin plots for all the systems together
- Figure 4: final trends eta vs sfr/mstar (used in the paper)
"""
import numpy as np
...
if plot0:
    ...
    if plot_saving:
        ...
        path = os.path.join(my_dir.plot_dir, name)
        plt.savefig(path)
